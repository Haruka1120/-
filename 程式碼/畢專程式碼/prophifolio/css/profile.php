...
<body>
   ...
   <header>
      ...
      <div class="logo">
         <a href="index.html" style="margin:0; width: 120px; height: 32px;"><img style="width: 120px; height: 32px;" alt="" src="images/logo.png"></a>
      </div>
      ...
      <nav id="nav-wrap">         
		...
		<ul id="nav" class="nav">
			<li><s style="background-color: #DDDDDD; display: inline-block; padding: 0; font-size: 18px; line-height: 38px; text-decoration: none; text-align: left"><a href="k_line.php">股票搜尋</a></s></li>
	   ...
	   <div class="row">
		   ...
		   <div class="twelve columns">
			   ...
			   <div class="hero-text">
				   ...
				   <h1 class="responsive-headline"  style="font-weight:300; margin-bottom:64px;">個人頁面</h1>
...
for ($i = 0 ; $i < count($code_array) ; $i++){
  ...
  $result_CHT     = $code_array[$i] . " " . mysql_fetch_row($get_codeCHT)[0];
    ...
    echo '<form action="k_line.php" method="Post"> <button style="background-color:red;" name="number" value="' . $code_array[$i] . '">' . $result_CHT . '</button></form>';
    echo '</div>';
...
<!--  股票收藏===================-->
   ...
   <footer>
      ...
      <div class="row">         
            ...
            <p>
				<pre>國立嘉義大學資訊管理學系 (<a href="http://www.ncyu.edu.tw/mis/" target="_blank"><u>National Chiayi University, Department of Management Information System</u></a>) 第12屆資訊系統專題發表 — 第六組 &#60Prophitfolio&#62</pre>
			<p class="copyright">&copy; 2017 NCYU_MIS | Design by Group VI</p>
